...
function getAnimation(){
    ...
    masterTL.add("start");
    masterTL.from("#logoWrapper", 0.5, {scale:0, ease:Back.easeOut}, "start")
    masterTL.to("#logoWrapper", 0.4, {width:134, height:90, ease:Sine.easeInOut})
    masterTL.to("#logo", 0.5, {x:-9, ease:Sine.easeInOut}, '-=0.4')
    ...
    masterTL.to("#logoWrapper", 0.4, {width:290, ease:Sine.easeInOut}, "+=1")
