...
function getAnimation(){
    ...
    masterTL.to("#logoWrapper", 0.4, {width:200, ease:Sine.easeInOut})
    ...
    masterTL.to("#text1", 0.3, {autoAlpha:0, ease:Sine.easeIn}, "+=1")
    masterTL.to("#text1", 0, {display:"none", ease:Sine.easeIn})
    masterTL.to("#logoWrapper", 0.4, {width:290, ease:Sine.easeInOut})
