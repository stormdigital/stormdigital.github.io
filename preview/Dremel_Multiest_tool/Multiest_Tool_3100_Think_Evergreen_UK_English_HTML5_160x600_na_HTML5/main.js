...
function getAnimation(){
    ...
    masterTL.add("start");
    masterTL.from("#logo", 0.5, {width:100, bottom:"50%", y:"50%", ease:Sine.easeOut}, "start+=0.5")
    ...
    masterTL.from("#product", 0.5, {x:40, ease:Back.easeOut}, "showProduct5")
    for(var i=1; i<6; i++){
    ...
    for(var i=1; i<6; i++){
        masterTL.to("#toolsWrapper", 0.5, {y:"+=80", ease:Sine.easeInOut}, "caroussel+="+(i-1)*1)
