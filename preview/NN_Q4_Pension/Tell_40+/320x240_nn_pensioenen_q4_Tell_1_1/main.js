...
function getAnimation(){
    ...
    masterTL.to("#logoWrapper", 0.4, {width:295, height:126, ease:Sine.easeInOut})
    masterTL.from(split.words, {opacity: 0, x:-10, ease:Sine.easeOut, stagger: 0.02});
    masterTL.from("#cta", 0.5, {scale:0, ease:Back.easeOut})
    masterTL.to("#logoWrapper", 0.4, {height:215, ease:Sine.easeInOut}, "+=1")
    masterTL.to("#text1", 0.4, {top: 27}, "-=0.4")
    masterTL.from("#endText", 0.3, {opacity:0, ease:Sine.easeOut})
    masterTL.to("#endText", 0.4, {top: 25}, "-=0.3")
