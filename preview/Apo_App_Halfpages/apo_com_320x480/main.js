...
function getAnimation(){
    ...
    masterTL.from("#phoneWrapper", 1.5, {rotation:-90, x:-320, y:400, scale:0.8, ease:"back.out(1)"}, "+=0.2")
    ...
    masterTL.to("#phoneWrapper", 0.75, {rotation:-45, x:-320, y:100, scale:0.8, ease:"back.in(1)"})
    masterTL.to("#text4", 0.3, {opacity:0, ease:Sine.easeIn}, "-=0.75")
    
    masterTL.to("#logo", 0.75, {scale:1, left:46, top: 213, ease:Sine.easeIn}, "-=0")
