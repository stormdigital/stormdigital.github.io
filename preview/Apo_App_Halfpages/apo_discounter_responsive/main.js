...
function getAnimation(){
    ...
    masterTL = gsap.timeline({paused:true, onStart:function(){
        ...
        gsap.to("#phoneWrapper", 3.25, {rotation:3, repeat:3, yoyo:true, delay:5, ease:Sine.easeInOut})
    }});
    ...
    masterTL.to("#phoneWrapper", 0.25, {opacity:0}, "-=0.25")
    ...
    masterTL.to("#handAndBox", 1.5, {y:15, ease:Sine.easeIn})
    
    masterTL.from("#whiteBg", 0.5, {opacity:0, ease:Sine.easeOut}, "+=0")
    masterTL.to("#logo", 0.5, {opacity:0, ease:Sine.easeIn}, "-=0.5")
