...
function getAnimation(){
    ...
    masterTL.to("#contentRight", 1, {scale:2.75, x:-70, y:-26, ease:Sine.easeInOut}, "start+=4.5")
    masterTL.to("#bg", 1, {x:-150, ease:Sine.easeInOut}, "start+=4.5")
    masterTL.to("#text1", 1, {x:-175, ease:Sine.easeInOut}, "start+=4.5")
    masterTL.to("#product", 3, {scale:1.05, x:-5, ease:Sine.easeInOut}, "start+=4.5")
    ...
    masterTL.from("#sticker", 0.5, {scale:0, rotation:360, ease:Back.easeOut}, "start+=8.8")
    ...
    masterTL.from("#tagline", 0.5, {opacity:0, ease:Sine.easeOut}, "start+=11.5")
    masterTL.from("#logoBarissimo2", 0.5, {opacity:0, ease:Sine.easeOut}, "start+=11.75")
