...
function getAnimation(){
    ...
    masterTL.from("#text1", 0.3, {opacity:0, ease:Sine.easeOut})
    masterTL.from("#highlight1Wrapper", 0.7, {width:0, ease:Sine.easeOut}, "+=0.3");
    masterTL.to("#highlight1Wrapper", 0.3, {opacity:0, ease:Sine.easeIn}, "+=2.5");
    masterTL.to("#text1", 0.3, {opacity:0, ease:Sine.easeIn}, "-=0.1");
    masterTL.from("#text2", 0.3, {opacity:0, ease:Sine.easeOut})
    masterTL.from("#highlight2Wrapper", 0.7, {width:0, ease:Sine.easeOut}, "+=0.3");
    masterTL.from("#product1", 1, {x:200, ease:Power4.easeOut}, "-=0");
    ...
    masterTL.to("#logo", 1, {width: 56, left:"50%", translateX:"-50%", ease:Sine.easeInOut}, "-=1");
    masterTL.from("#tagline", 1, {opacity:0, ease:Sine.easeOut});
    masterTL.from("#text3", 0.3, {opacity:0, ease:Sine.easeOut})
    masterTL.from("#highlight3Wrapper", 0.7, {width:0, ease:Sine.easeOut}, "+=0.3");
