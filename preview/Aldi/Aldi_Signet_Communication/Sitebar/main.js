...
function getAnimation(){
    ...
    masterTL.to("#contentRight", 1, {scale:2.4, y:-300, ease:Sine.easeInOut}, "start+=4.5")
    masterTL.to("#bg", 1, {y:-600, ease:Sine.easeInOut}, "start+=4.5")
    masterTL.to("#text1", 1, {y:-1200, ease:Sine.easeInOut}, "start+=4.5")
    masterTL.to("#product", 3, {scale:1.6, ease:Sine.easeInOut}, "start+=4.5")
    ...
    masterTL.from("#date", 0.5, {opacity:0, ease:Sine.easeOut}, "start+=8.5")
    ...
    masterTL.to(["#sticker", "#product", "#price", "#date"], 0.5, {opacity:0, ease:Power1.easeIn}, "start+=11")
