...
function getAnimation(){
    ...
    masterTL.to(["#text2", "#highlightWrapper2", "#date", "#date2"], 0.5, {opacity:0, ease:Sine.easeInOut}, "start+=12.5")
    ...
    masterTL.from("#ctaLeft", 0.5, {scale:0, transformOrigin:"80% 50%", ease:Back.easeOut}, "start+=14");
