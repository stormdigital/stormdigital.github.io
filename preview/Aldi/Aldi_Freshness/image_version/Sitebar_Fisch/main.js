...
function getAnimation(){
    ...
    masterTL.from("#text2F", 0.3, {opacity:0, ease:Sine.easeOut},"-=0.1")
    masterTL.from("#text2G", 0.3, {opacity:0, ease:Sine.easeOut},"-=0.1")
    ...
    masterTL.to("#text2F", 0.3, {opacity:0, ease:Sine.easeIn}, "-=0.2")
    masterTL.to("#text2G", 0.3, {opacity:0, ease:Sine.easeIn}, "-=0.2")

    masterTL.to("#stickerOverlayWrapper", 0.75, {y:-705, ease:Power0.easeNone});
    masterTL.from("#stickerOverlayWrapper", 0.4, {scale:1.2, opacity:0, ease:Power4.easeOut}, "-=0.75");
    masterTL.to("#stickerOverlay", 0.5, {y:331, ease:Power0.easeNone}, "-=0.5");
    masterTL.from("#stickerWrapper", 0.55, {height:0, ease:Power0.easeNone}, "-=0.6");
