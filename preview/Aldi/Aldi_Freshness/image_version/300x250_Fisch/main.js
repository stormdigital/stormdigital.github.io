...
function getAnimation(){
    ...
    masterTL.to("#stickerOverlayWrapper", 0.75, {y:-249, ease:Power0.easeNone});
    masterTL.from("#stickerOverlayWrapper", 0.4, {scale:1.2, ease:Power4.easeOut}, "-=0.75");
    masterTL.to("#stickerOverlay", 0.5, {y:73, ease:Power0.easeNone}, "-=0.5");
    masterTL.from("#stickerWrapper", 0.5, {height:0, ease:Power0.easeNone}, "-=0.47");
