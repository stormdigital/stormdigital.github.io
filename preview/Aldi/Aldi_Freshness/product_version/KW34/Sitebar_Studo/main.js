...
function onResize(){
    ...
    if(bannerW < scalerW/2){
        ...
        gsap.set(["#date", "#product1Disclaimer", "#product2Disclaimer"], {x:-300});
        ...
        gsap.set(["#date", "#product1Disclaimer", "#product2Disclaimer"], {x:-((scalerW - screenW)/2)/bannerS});
    }
    else{
...
function getAnimation(){
    ...
    masterTL.from(["#product2Disclaimer", "#product2Disclaimer2"], 0.3, {opacity:0, ease:Sine.easeOut}, "-=0.4");  
