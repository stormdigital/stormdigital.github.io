...
function getAnimation(){
    ...
    masterTL.to("#topBlock", 0.5, {width:34, height:30, ease:Sine.easeOut}, "start+=3.5");
    masterTL.to("#tagline", 0.3, {opacity:0, ease:Sine.easeIn}, "start+=3.7");
    masterTL.to("#introWrapper", 0.8, {scale:0.69, ease:Power3.easeInOut}, "start+=3.5");
    masterTL.to("#introWrapper", 0.8, {y: 2, ease:Power3.easeInOut}, "start+=3.5");
    masterTL.to("#introWrapper", 0.8, {x:170, ease:"back.inOut(3)"}, "start+=3.5");
    masterTL.to("#topBlock", 0.15, {x:10, ease:Sine.easeInOut, repeat:1, yoyo:true}, "start+=4");
    ...
    masterTL.from("#naturland", 0.8, {x:-180, ease:Power1.easeOut}, "start+=7.5");
