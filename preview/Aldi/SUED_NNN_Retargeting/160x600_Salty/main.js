...
function getAnimation(){
    ...
    masterTL.add("start");
    masterTL.fromTo("#bgWrapper", 7, {x:0}, {x:-70, ease:Sine.easeInOut}, "start");
    ...
    masterTL.to("#logo", 0.5, {width:50, y:-310, ease:Sine.easeInOut}, "start+=13.8");
    masterTL.from("#endText", 0.5, {opacity:0, y:20, ease:Sine.easeInOut}, "start+=14");
    masterTL.from("#ctaWrapper", 0.5, {scale:1.5, ease:Back.easeOut}, "start+=14.2");
