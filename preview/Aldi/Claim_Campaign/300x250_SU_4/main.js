...
function getAnimation(){
    ...
    masterTL.to("#product1", 1, {x:-130, ease:Sine.easeInOut}, "showProduct2")
    masterTL.from("#product2", 1, {x:150, ease:Sine.easeInOut, onComplete:function(){
        gsap.set("#product2Bg", {right:0});
    }}, "showProduct2")
    masterTL.to(["#text1HighlightWrapper", "#text1"], 1, {scale:0.60754716981, ease:Sine.easeInOut}, "showProduct2")
    ...
    masterTL.to("#product1", 1, {x:-410, ease:Sine.easeInOut}, "endscreen")
