...
function getAnimation(){
    ...
    masterTL.to("#product1", 1, {x:-90, ease:Sine.easeInOut}, "showProduct2")
    masterTL.from("#product2", 1, {x:150, ease:Sine.easeInOut, onComplete:function(){
        gsap.set("#product2Bg", {right:0});
    }}, "showProduct2")
    masterTL.to(["#text1HighlightWrapper", "#text1"], 1, {scale:0.61349693251, x:-16, y:2, ease:Sine.easeInOut}, "showProduct2")
    ...
    masterTL.from("#payOff1", 0.5, {x:-110, ease:Sine.easeInOut}, "showProduct3")
    masterTL.from("#payOff2", 0.5, {x:110, ease:Sine.easeInOut}, "showProduct3+=0.3")
    masterTL.from("#payOff3", 0.5, {x:-110, ease:Sine.easeInOut}, "showProduct3+=0.6")
    ...
    masterTL.to("#product1", 1, {x:-370, ease:Sine.easeInOut}, "endscreen")
    masterTL.to("#product2", 1, {x:-320, ease:Sine.easeInOut}, "endscreen")
