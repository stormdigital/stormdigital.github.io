...
function getAnimation(){
    ...
    masterTL.to("#product1", 1, {y:-190, ease:Sine.easeInOut}, "showProduct2")
    masterTL.from("#product2", 1, {y:300, ease:Sine.easeInOut, onComplete:function(){
        gsap.set("#product2Bg", {bottom:0});
    }}, "showProduct2")
    masterTL.to(["#text1HighlightWrapper", "#text1"], 1, {scale:0.61349693251, y:-82, ease:Sine.easeInOut}, "showProduct2")
    ...
    masterTL.from("#payOff1", 0.5, {x:-160, ease:Sine.easeInOut}, "showProduct3")
    masterTL.from("#payOff2", 0.5, {x:160, ease:Sine.easeInOut}, "showProduct3+=0.3")
    masterTL.from("#payOff3", 0.5, {x:-160, ease:Sine.easeInOut}, "showProduct3+=0.6")
    ...
    masterTL.to("#product1", 1, {y:-570, ease:Sine.easeInOut}, "endscreen")
    masterTL.to("#product2", 1, {y:-600, ease:Sine.easeInOut}, "endscreen")
    masterTL.to("#product2Bg", 0.9, {height:"100%", ease:Sine.easeIn}, "endscreen")
    masterTL.to("#logo", 0.5, {scale:2.3023255814, left:"50%", translateX:"-50%", top:142, ease:Sine.easeInOut}, "endscreen+=0.6")
