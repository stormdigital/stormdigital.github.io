...
function getAnimation(){
    ...
    masterTL.to("#product1", 1, {scale:0.8, x:-65, y:8, ease:Sine.easeInOut}, "showProduct2")
    masterTL.from("#product2", 1, {x:150, ease:Sine.easeInOut, onComplete:function(){
        gsap.set("#product2Bg", {right:0});
    }}, "showProduct2")
    masterTL.to(["#text1HighlightWrapper", "#text1"], 1, {scale:0.60544217687, ease:Sine.easeInOut}, "showProduct2")
