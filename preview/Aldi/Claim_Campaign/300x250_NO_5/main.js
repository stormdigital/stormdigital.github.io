...
function getAnimation(){
    ...
    masterTL.to("#product1", 1, {scale:0.8, x:-63, y:13, ease:Sine.easeInOut}, "showProduct2")
    masterTL.from("#product2", 1, {x:150, ease:Sine.easeInOut, onComplete:function(){
        gsap.set("#product2Bg", {right:0});
    }}, "showProduct2")
    masterTL.to(["#text1HighlightWrapper", "#text1"], 1, {scale:0.61046511627, ease:Sine.easeInOut}, "showProduct2")
    ...
    masterTL.to("#product1", 1, {x:-290, ease:Sine.easeInOut}, "endscreen")
    masterTL.to("#product2", 1, {x:-290, ease:Sine.easeInOut}, "endscreen")
