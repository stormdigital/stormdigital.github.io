...
function getAnimation(){
    ...
    masterTL.to("#product1", 1, {x:-110, ease:Sine.easeInOut}, "showProduct2")
    masterTL.from("#product2", 1, {x:150, ease:Sine.easeInOut, onComplete:function(){
        gsap.set("#product2Bg", {right:0});
    }}, "showProduct2")
    masterTL.to(["#text1HighlightWrapper", "#text1"], 1, {scale:0.60763888888, ease:Sine.easeInOut}, "showProduct2")
