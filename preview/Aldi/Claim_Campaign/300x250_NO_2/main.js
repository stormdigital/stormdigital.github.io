...
function getAnimation(){
    ...
    masterTL.to(["#text1HighlightWrapper", "#text1"], 1, {scale:0.57692307692, ease:Sine.easeInOut}, "showProduct2")
    ...
    masterTL.to("#product1", 1, {x:-270, ease:Sine.easeInOut}, "endscreen")
    masterTL.to("#product2", 1, {x:-270, ease:Sine.easeInOut}, "endscreen")
