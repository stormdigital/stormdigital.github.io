...
function getAnimation(){
    ...
    masterTL.to("#product1", 1, {y:-300, ease:Sine.easeInOut}, "showProduct2")
    masterTL.from("#product2", 1, {y:600, ease:Sine.easeInOut, onComplete:function(){
        gsap.set("#product2Bg", {bottom:0});
    }}, "showProduct2")
    masterTL.to(["#text1HighlightWrapper", "#text1"], 1, {scale:0.52193995381, transformOrigin:"335px 238px", y:-200, ease:Sine.easeInOut}, "showProduct2")
    ...
    masterTL.to(["#text1HighlightWrapper", "#text1", "#text2HighlightWrapper", "#text2", "#text3", "#text3HighlightWrapper"], 0.5, {opacity:0, ease:Sine.easeInOut}, "endScreen")
    masterTL.to("#product1", 1, {y:-1200, ease:Sine.easeInOut}, "endscreen")
    masterTL.to("#product2", 1, {y:-1200, ease:Sine.easeInOut}, "endscreen")
    masterTL.to("#product2Bg", 1, {height:"100%", ease:Sine.easeIn}, "endscreen")
    masterTL.to("#logo", 0.5, {scale:2.44859813084, right:"50%", top:280, translateX:"50%", transformOrigin:"50% 0%", ease:Sine.easeInOut}, "endscreen+=0.3")
    masterTL.from("#tagline", 0.5, {opacity:0, ease:Sine.easeInOut}, "endscreen+=0.9")
    masterTL.from("#ctaLeft", 0.5, {scale:0, transformOrigin:"50% 95%", ease:Back.easeOut}, "endscreen+=1.1");
    masterTL.from("#ctaRight", 0.01, {opacity:0, ease:Sine.easeOut}, "endscreen+=1.8");
    masterTL.from("#ctaRight", 0.3, {x:-50, ease:Sine.easeOut}, "endscreen+=1.8");
