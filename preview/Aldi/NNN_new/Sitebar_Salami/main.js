...
function getAnimation(){
    ...
    masterTL.fromTo("#bgWrapper", 0.5,{'-webkit-filter':'blur(0px) brightness(1)','filter':'blur(0px) brightness(1)'}, {'-webkit-filter':'blur(10px) brightness(0.85)','filter':'blur(10px) brightness(0.85)', ease:Sine.easeInOut}, "start+=15");
    masterTL.to("#logo", 0.5, {width:146, y:-582, ease:Sine.easeInOut}, "start+=15.2");
