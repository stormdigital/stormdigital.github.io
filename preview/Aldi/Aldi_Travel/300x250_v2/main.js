...
function getAnimation(){
    ...
    masterTL.to("#bluePanel", 0.3, {height:62, ease:Sine.easeInOut}, "+=0")
    masterTL.from("#usp2", 0.5, {scale:0, ease:"back.out(1.2)"}, "+=0")
    masterTL.to("#bluePanel", 0.3, {height:90, ease:Sine.easeInOut}, "+=0")
    masterTL.from("#usp3", 0.5, {scale:0, ease:"back.out(1.2)"}, "+=0.1")
    masterTL.to("#bluePanel", 0.3, {height:120, ease:Sine.easeInOut}, "+=0")
