...
function getAnimation(){
    ...
    masterTL.from("#brochure", 1, {scale:4, y:-320, x:71, rotation:-5, ease:Power2.easeInOut}, "start+=2.7")
    ...
    masterTL.to(["#logo", "#topic1", "#topic2", "#topic3"], 0.5, {opacity:0, ease:Sine.easeInOut}, "8.2")
