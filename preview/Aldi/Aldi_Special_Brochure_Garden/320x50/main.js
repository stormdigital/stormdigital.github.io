...
function getAnimation(){
    ...
    masterTL.from("#brochure", 1, {scale:4.5, y:146, x:336, rotation:-6, ease:Power2.easeInOut}, "start+=2.7")
    ...
    masterTL.to(["#topic1", "#topic2", "#topic3", "#brochure"], 0.5, {opacity:0, ease:Sine.easeInOut}, "8.2")
