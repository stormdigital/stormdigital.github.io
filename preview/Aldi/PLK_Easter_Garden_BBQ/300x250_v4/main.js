...
function getAnimation(){
    ...
    masterTL.from("#product1", 0.7, {scale:0, y:300, ease:Back.easeOut}, "showProduct1+=0.5")
    ...
    masterTL.from("#product2", 0.7, {scale:0, y:300, ease:Back.easeOut}, "showProduct2+=0.5")
