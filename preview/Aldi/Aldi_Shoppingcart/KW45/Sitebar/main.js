...
function getAnimation(){
    ...
    masterTL.from("#tagline2", 0.5, {scale:0, ease:Sine.easeOut}, "start+=0.8");
    masterTL.from("#tagline2", 0.7, {y:-70, ease:Back.easeOut}, "start+=0.8");
    ...
    masterTL.from("#sticker2", 0.3, {opacity:0, ease:Sine.easeInOut}, "start+=1");

    masterTL.to(["#sticker2", "#introWrapper2"], 0.3, {opacity:0, ease:Sine.easeInOut}, "+=1");
