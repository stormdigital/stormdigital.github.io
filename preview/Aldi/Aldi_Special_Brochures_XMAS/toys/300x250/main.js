...
function getAnimation(){
    ...
    masterTL.from("#brochure", 1, {scale:2.4, y:-19, x:-150, rotation:2, ease:Power2.easeInOut}, "start+=2.7")
    ...
    masterTL.from("#topic2", 0.5, {x:-200, ease:Sine.easeOut}, "start+=5.5")
    masterTL.to("#topic2", 0.3, {opacity:0, ease:Sine.easeIn}, "start+=7.5")
    masterTL.from("#topic3", 0.5, {x:-200, ease:Sine.easeOut}, "start+=7.5")
    masterTL.to(["#logo", "#topic3", "#brochure", "#deco1"], 0.5, {opacity:0, ease:Sine.easeInOut}, "9.5")
