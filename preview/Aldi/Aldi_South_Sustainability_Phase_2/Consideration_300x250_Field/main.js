...
function getAnimation(){
    ...
    masterTL.from("#date", 0.5, {x:150, ease:Sine.easeOut}, "showFrame2+=1.3")
    ...
    masterTL.from("#text3White", 0.5, {y:200, ease:Sine.easeOut}, "showFrame3+=0.5")
    masterTL.from(["#text3HighlightWrapper", "#text4HighlightWrapper"], 0.5, {width:0, ease:Sine.easeOut}, "showFrame3+=1.2")
