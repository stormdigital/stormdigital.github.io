...
function getAnimation(){
    ...
    masterTL.to(["#text1", "#text1HighlightWrapper"], 0.5, {opacity:0, ease:Sine.easeInOut}, "showFrame2")
    masterTL.from("#text2", 0.5, {y:1000, ease:Sine.easeOut}, "showFrame2+=0.5")
    masterTL.from("#text2HighlightWrapper", 0.7, {width:0, ease:Sine.easeInOut}, "showFrame2+=1.2")
    masterTL.to(["#text2", "#text2HighlightWrapper"], 0.5, {opacity:0, ease:Sine.easeInOut}, "showFrame2+=3.5")
