...
function getAnimation(){
    ...
    masterTL.add("start");
    masterTL.fromTo("#bgWrapper", 8, {x:-800}, {x:-1009, ease:Sine.easeInOut}, "start+=2");
    ...
    masterTL.to("#bgWrapper", 0.5, {'-webkit-filter':'blur(3px) grayscale(0.2)','filter':'blur(3px) grayscale(0.2)', ease:Sine.easeInOut}, "start+=15");
