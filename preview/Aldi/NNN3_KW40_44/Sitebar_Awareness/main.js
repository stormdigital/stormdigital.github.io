...
function getAnimation(){
    ...
    masterTL.add("start");
    // masterTL.fromTo("#bgWrapper", 6, {x:0}, {x:-128, ease:Sine.easeOut}, "start");
    ...
    masterTL.to("#bgWrapper", 0.5, {'-webkit-filter':'blur(10px)','filter':'blur(10px)', ease:Sine.easeInOut}, "start+=9");
    masterTL.to("#logo", 0.5, {width:146, y:-582, ease:Sine.easeInOut}, "start+=9.2");
    masterTL.from("#endText", 0.5, {opacity:0, y:20, ease:Sine.easeInOut}, "start+=9.4");
    masterTL.from("#ctaLeft", 0.5, {scale:0, transformOrigin:"50% 95%", ease:Back.easeOut}, "start+=10");
    masterTL.from("#ctaRight", 0.01, {opacity:0, ease:Sine.easeOut}, "start+=10.5");
    masterTL.from("#ctaRight", 0.3, {x:-50, ease:Sine.easeOut}, "start+=10.5");
