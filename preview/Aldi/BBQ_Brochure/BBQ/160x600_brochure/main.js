...
function getAnimation(){
    ...
    masterTL.from("#brochure", 1, {scale:4.6, y:42, x:222, rotation:-6, ease:Power2.easeInOut}, "start+=2.7")
    masterTL.from("#endAsset1", 1, {x:-50, ease:Sine.easeOut}, "start+=4")
    masterTL.from("#endAsset1", 1.3, {rotation:-60, ease:Back.easeOut}, "start+=4")
    masterTL.to("#endAsset1", 0.8, {rotation:-15, repeat:1, yoyo:true, ease:Sine.easeInOut}, "start+=5.3")
    masterTL.from("#endAsset2", 0.5, {x:100, y:100, ease:Sine.easeOut}, "start+=4.1")
    ...
    masterTL.to("#brochure", 4, {rotation:0, y:40, ease:Sine.easeInOut}, "start+=3.5")
    masterTL.to(["#logo", "#topic1", "#topic2", "#topic3", "#endAsset1", "#endAsset2"], 0.5, {opacity:0, ease:Sine.easeInOut}, "8.2")
