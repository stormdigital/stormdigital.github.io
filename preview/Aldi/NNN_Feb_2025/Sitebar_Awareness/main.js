...
function getAnimation(){
    ...
    // masterTL.to("#bg", 2, {x:-30, ease:Sine.easeInOut}, "intro+=1");
    // masterTL.to(["#cow"], 2, {x:-40, ease:Sine.easeInOut}, "intro+=1");
    // masterTL.to("#product", 2, {x:-55, ease:Sine.easeInOut}, "intro+=1");
    ...
    masterTL.to("#introWrapper", 0.8, {scale:0.26, x:-2, y:-59, ease:"Sine.inOut"}, "start+=3.5");
    ...
    // masterTL.to("#arrow1", 0.5, {opacity:1, x:0, y:0, ease:Sine.easeOut}, "showUSP1+=0.31");
