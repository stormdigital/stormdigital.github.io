...
function getAnimation(){
    ...
    masterTL.from(["#cow", "#head"], 2, {scale:1.3, ease:Sine.easeOut}, "intro");
    masterTL.from("#product", 2, {scale:1.8, ease:Sine.easeOut}, "intro");
    masterTL.to("#bg", 2, {x:-50, ease:Sine.easeInOut}, "intro+=1");
    masterTL.to(["#cow", "#head"], 2, {x:-65, ease:Sine.easeInOut}, "intro+=1");
    ...
    masterTL.to(["#bg", "#cow", "#head", "#product"], 0.5, {'-webkit-filter':'blur(6px)','filter':'blur(6px)', ease:Sine.easeInOut}, "endScreen");
