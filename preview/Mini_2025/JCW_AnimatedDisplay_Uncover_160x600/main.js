...
function getAnimation(){
    ...
    masterTL.from("#bg1", 4, {scale:1.03, transformOrigin:"80% 100%", ease:Sine.easeInOut}, "start")
    ...
    masterTL.to("#bg1", 0.3, {scale:1.03, ease:Sine.easeInOut}, "switchBg1")
    ...
    for (let i = 3; i <= 12; i++) {
        if(i == 5 || i == 7 || i == 9 || i == 11){
            ...
            masterTL.set("#bg"+(i-2), {scale:1.2, ease: Sine.easeOut}, "+=0.7");
            masterTL.from("#bg"+i, 0.35, {scale:1.2, opacity:0, ease: Sine.easeOut});
            masterTL.to("#bg"+(i-2), 0.35, {scale:1, opacity:1, ease: Sine.easeOut}, "-=0.35");
            masterTL.to("#bg"+i, 0.35, {scale:1, ease: Sine.easeOut}, "+=0.35");
        } else {
