...
function getAnimation(){
    ...
    masterTL.add("start");
    masterTL.to("#bg", 1.5, {x:-900, ease:Sine.easeOut}, "start")
    masterTL.from("#product2", 2, {x:320, ease:Power4.easeOut}, "-=0.4")
    masterTL.from("#product3", 2, {x:340, ease:Power4.easeOut}, "-=2.05")
    masterTL.from("#product1", 1.5, {x:-300, ease:Power4.easeOut}, "-=1.5")
    masterTL.to("#product1", .4, {rotation:8, repeat:1, yoyo:true, ease:Sine.easeOut}, "-=1.3")
    masterTL.add("screen2", "+=0.3");
    masterTL.to("#bg", 1, {x:"+=80", ease:Sine.easeInOut}, "screen2")
    masterTL.to(["#product1", "#product2", "#product3"], 1, {x:"+=120", ease:Sine.easeInOut}, "screen2")
    masterTL.from("#date", 0.5, {opacity:0, ease:Sine.easeOut}, "screen2+=1")
    masterTL.from(["#badgeBg", "#badge1", "#badge2", "#badge3", "#badge4", "#badge5"], 0.5, {opacity:0, ease:Sine.easeOut}, "screen2+=1.4")
    ...
    masterTL.from("#text1", 0.5, {x:-1200, ease:Sine.easeOut}, "screen2+=4.3")
    ...
    masterTL.from("#text2", 0.5, {x:-1200, ease:Sine.easeOut}, "+=0.2")
    masterTL.from("#highlight2Wrapper", 0.5, {width:0, ease:Sine.easeInOut}, "+=0.3")
    masterTL.from("#ctaLeft", 0.5, {scale:0, transformOrigin:"50% 90%", ease:Back.easeOut}, "+=0.2")
