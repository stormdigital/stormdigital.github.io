...
function getAnimation(){
    ...
    masterTL.add("start");
    masterTL.from("#bg1", 6, {scale:1.2, ease:Sine.easeOut}, "start")
    masterTL.from("#text1", 0.7, {x:-50, opacity:0, ease:Power2.easeInOut}, "start+=0.2")
    masterTL.from(document.querySelectorAll(".blueLine")[0], 0.5, {width:0, ease:Power2.easeInOut}, "start+=0.9")
    masterTL.to("#text1", 0.7, {x:50, opacity:0, ease:Power2.easeInOut}, "start+=4.3")
    masterTL.from("#bg2", 5, {scale:1.2, ease:Sine.easeOut}, "start+=5")
    masterTL.from("#bg2", 0.5, {opacity:0, ease:Sine.easeInOut}, "start+=5")
    masterTL.from("#tesaWrapper", 0.5, {width:0, ease:Sine.easeInOut}, "start+=5.5")
    masterTL.from("#tadaa1", 0.5, {y:150, scale:0, x:80, ease:Back.easeOut}, "start+=5.7")
    masterTL.from("#tadaa2", 0.5, {y:150, scale:0, x:44, ease:Back.easeOut}, "start+=5.76")
    masterTL.from("#tadaa3", 0.5, {y:150, scale:0, x:6, ease:Back.easeOut}, "start+=5.8")
    masterTL.from("#tadaa4", 0.5, {y:150, scale:0, x:-30, ease:Back.easeOut}, "start+=5.85")
    ...
    masterTL.fromTo("#mainProduct", 1, {opacity:0, y:70},  {opacity:1, y:-28, scale:1.63, ease:"elastic.out(0.5 ,0.4)"}, "start+=8")
    ...
    masterTL.to("#mainProduct", 0.5, {scale:1, y:0}, "start+=10.3")
