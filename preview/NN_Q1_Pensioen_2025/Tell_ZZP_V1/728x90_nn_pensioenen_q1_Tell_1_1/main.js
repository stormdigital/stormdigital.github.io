...
function getAnimation(){
    ...
    masterTL.to("#logoWrapper", 0.4, {width:365, height:80, ease:Sine.easeInOut})
    ...
    //masterTL.to("#text1", 0.3, {width: 200, top: 20, fontSize: 18, ease:Sine.easeOut}, "-=0.4")
    masterTL.to("#text1", 0.2, {opacity: 0, ease:Sine.easeOut}, "-=0.4")
    masterTL.to("#text2", 0.5, {opacity: 1, ease:Sine.easeOut})
