...
function getAnimation(){
    ...
    masterTL.from("#mainProduct", 1, {opacity:0, y:70, ease:"elastic.out(0.5 ,0.4)"}, "-=0.5")
    ...
    masterTL.to("#bg4", 0.5, {'-webkit-filter':'blur(3px)','filter':'blur(3px)', ease:Sine.easeInOut}, "-=0.3");
    masterTL.from("#text5", 0.7, {x:-50, opacity:0, ease:Power2.easeInOut}, "-=0.2")
    masterTL.from("#highlight5Wrapper", 0.8, {width:0, ease:Power2.easeInOut}, "-=0")
    masterTL.to(["#text5", "#highlight5Wrapper"], 0.7, {x:50, opacity:0, ease:Power2.easeInOut}, "+=1.5")
