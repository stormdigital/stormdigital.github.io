...
function getAnimation(){
    ...
    masterTL.from("#blueCircle", 1.25, {scaleY:0, ease:"elastic.out(0.5,0.3)"}, "-=3.5")
    masterTL.from("#mainProduct", 1, {opacity:0, y:70, ease:"elastic.out(0.5 ,0.4)"}, "-=3")
    masterTL.from(["#cta", "#ctaBorder"], 1, {opacity:0, y:70, ease:"elastic.out(0.5 ,0.4)"}, "-=2.3")
    
    masterTL.to("#bg4", 0.5, {'-webkit-filter':'blur(3px)','filter':'blur(3px)', ease:Sine.easeInOut}, "-=2");
    masterTL.from("#text5", 0.7, {x:-50, opacity:0, ease:Power2.easeInOut}, "-=1.7")
    masterTL.from("#highlight5Wrapper", 0.8, {width:0, ease:Power2.easeInOut}, "-=1")
    ...
    masterTL.from("#highlight6Wrapper", 0.8, {width:0, ease:Power2.easeInOut}, "-=0")
