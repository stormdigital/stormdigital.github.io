...
function getAnimation(){
    ...
    masterTL.add("start");
    masterTL.from("#bg", 7, {scale:1.1, ease:Sine.easeOut}, "start")
    masterTL.from("#phoneWrapper", 7, {scale:1.5, ease:Sine.easeOut}, "start")
    masterTL.from("#head", 7, {scale:2, ease:Sine.easeOut}, "start")
