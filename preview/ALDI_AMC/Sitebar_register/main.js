...
function getAnimation(){
    ...
    masterTL.to(["#text3", "#highlightWrapper3"], 0.5, {x:-1200, ease:Sine.easeIn}, "start+=12")
    ...
    masterTL.from("#text4", 0.5, {x:1200, ease:Sine.easeOut}, "start+=13");
    ...
    masterTL.to("#logo", 0.5, {opacity:0, ease:Sine.easeInOut}, "start+=16")
    masterTL.from("#logo2", 0.5, {opacity:0, ease:Sine.easeInOut}, "start+=16.5")
    masterTL.to(["#text4", "#highlightWrapper4"], 0.5, {y:-150, ease:Sine.easeInOut}, "start+=16.3")
