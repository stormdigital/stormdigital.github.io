...
function getAnimation(){
    ...
    masterTL.to("#mainProduct", 0.4, {scale:1, ease:Back.easeOut}, "start+=9.5")
    masterTL.from("#leftProduct", 0.4, {x:70, opacity:0, ease:Back.easeOut}, "start+=9.5")
    masterTL.from("#rightProduct", 0.4, {x:-70, opacity:0, ease:Back.easeOut}, "start+=9.5")
