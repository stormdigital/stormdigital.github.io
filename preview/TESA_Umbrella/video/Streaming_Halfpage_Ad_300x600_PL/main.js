...
function getAnimation(){
    ...
    masterTL.to("#text1", 0.4, {x:50, opacity:0, ease:Power2.easeInOut}, "start+=4.5")
    masterTL.from("#text2", 0.7, {x:-50, opacity:0, ease:Power2.easeInOut}, "start+=5")
    masterTL.from("#mainProduct", 0.5, {opacity:0, y:70, ease:"elastic.out(0.5 ,0.4)"}, "start+=5")
    masterTL.from("#leftProduct", 0.4, {x:70, opacity:0, ease:Back.easeOut}, "start+=5.3")
    masterTL.from("#rightProduct", 0.4, {x:-70, opacity:0, ease:Back.easeOut}, "start+=5.3")
    masterTL.to("#cta", 0.25, {scale:1.15, ease:Sine.easeInOut, repeat:1, yoyo:true}, "start+=10")
    masterTL.to("#ctaBorder", 0.5, {scale:1.8, ease:Sine.easeIn, opacity:0}, "start+=7")
    masterTL.to("#ctaBorder", 0.5, {opacity:0}, "start+=7.5")
