...
function getAnimation(){
    ...
    masterTL.to("#logoWrapper", 0.4, {height:295, ease:Sine.easeInOut})
    masterTL.from(split.words, {opacity: 0, x:-10, ease:Sine.easeOut, stagger: 0.02});
    masterTL.from("#cta", 0.5, {scale:0, ease:Back.easeOut})
    masterTL.to("#logoWrapper", 0.4, {height:575, ease:Sine.easeInOut}, "+=1")
    masterTL.to("#text1", 0.3, {bottom:429, ease:Sine.easeOut}, "-=0.3")
    masterTL.to("#endText", 0.4, {top: 295})
    masterTL.from("#endText", 0.3, {opacity:0, ease:Sine.easeOut}, "-=0.1")
    masterTL.from("#disclaimerText", 0.4, {opacity: 0}, "-=0.3")
