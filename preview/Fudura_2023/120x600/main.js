...
function getAnimation(){
    ...
    arrowTL.fromTo("#bgWrapper", 0.4, {WebkitMaskPositionX:-320, MaskPositionX:-320}, {WebkitMaskPositionX:120, MaskPositionX:120, ease:Power0.easeNone});
    ...
    masterTL.add("start");
    masterTL.from(["#bg", "#bg2"], 3,{x:-10, ease:Sine.easeOut}, "start");
    masterTL.to(arrowTL, 3,{progress: 1, ease:Sine.easeOut}, "start");
    masterTL.from("#logo", 0.5,{opacity:0, ease:Sine.easeOut}, "start+=0.8");
    masterTL.from("#logoText", 0.5,{opacity:0, y:-10, ease:Sine.easeOut}, "start+=1");
