...
function init() {
    ...
    document.querySelector("#mainExit").addEventListener("mouseover", function(){
        if(masterTL.progress() == 1){
            ...
            gsap.to("#bgWrapper", 0.3, {WebkitMaskPositionX:335, MaskPositionX:335, ease:Sine.easeInOut});
        }
    })
    ...
    document.querySelector("#mainExit").addEventListener("mouseout", function(){
        if(masterTL.progress() == 1){
            ...
            gsap.to("#bgWrapper", 0.3, {WebkitMaskPositionX:320, MaskPositionX:320, ease:Sine.easeInOut});
        }
    })
...
function getAnimation(){
    ...
    arrowTL.to("#bgWrapper", 0.2, {WebkitMaskPositionX:320, MaskPositionX:320, ease:Sine.easeOut});
