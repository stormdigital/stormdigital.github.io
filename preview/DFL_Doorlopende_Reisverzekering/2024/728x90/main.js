...
function getUSPAnimation(){
    ...
    uspTL.from("#uspScreen", 0.5, {width: 205, ease:Sine.easeInOut});
    uspTL.to("#stickerWrapper", 0.5, {scale:1, opacity:1, y: 0, x: 321, rotation:0, ease:Sine.easeOut})
...
function getQuestionAnimation(){
    ...
    questionTL.from("#questionScreen", 0.5, {width: 205, ease:Sine.easeInOut});
    questionTL.to("#stickerWrapper", 0.5, {scale:1, opacity:1, y: 1, x: 332, rotation:0, ease:Sine.easeOut})
