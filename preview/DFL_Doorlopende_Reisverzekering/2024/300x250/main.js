...
function getUSPAnimation(){
    ...
    uspTL.from("#uspScreen", 0.5, {height:106, width: 205, x:-24, y:1, ease:Sine.easeInOut});
    uspTL.to("#stickerWrapper", 0.5, {scale:1, opacity:1, y: -72, x: 14, rotation:0, ease:Sine.easeOut})
...
function getQuestionAnimation(){
    ...
    questionTL.from("#questionScreen", 0.5, {height:106, width: 205, x:-23, y:1,ease:Sine.easeInOut});
    questionTL.to("#stickerWrapper", 0.5, {scale:1, opacity:1, y: -72, x: 14, rotation:0, ease:Sine.easeOut})
