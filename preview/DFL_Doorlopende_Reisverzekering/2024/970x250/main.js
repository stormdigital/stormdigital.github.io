...
function getUSPAnimation(){
    ...
    uspTL.to("#stickerWrapper", 0.5, {scale:1, opacity:1, y: -10, x: 344, rotation:0, ease:Sine.easeOut})
...
function getQuestionAnimation(){
    ...
    questionTL.from("#questionScreen", 0.5, {width: 372, ease:Sine.easeInOut});
    questionTL.to("#stickerWrapper", 0.5, {scale:1, opacity:1, y: 0, x: 338, rotation:0, ease:Sine.easeOut})
