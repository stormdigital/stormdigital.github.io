...
function getUSPAnimation(){
    ...
    uspTL.from("#uspScreen", 0.5, {width: 372,x:1, ease:Sine.easeInOut});
    uspTL.to("#stickerWrapper", 0.5, {scale:1, opacity:1, y:3, x: 335, rotation:0, ease:Sine.easeOut})
...
function getQuestionAnimation(){
    ...
    questionTL.from("#questionScreen", 0.5, {width: 372,x:1, ease:Sine.easeInOut});
    questionTL.to("#stickerWrapper", 0.5, {scale:1, opacity:1, y: 3, x: 336, rotation:0, ease:Sine.easeOut})
