...
function getUSPAnimation(){
    ...
    uspTL.from("#uspScreen", 0.5, {height:109, width: 205, x:-44, y:1, ease:Sine.easeInOut});
    uspTL.to("#stickerWrapper", 0.5, {scale:1, opacity:1, y: -92, x: 20, rotation:0, ease:Sine.easeOut})
...
function getQuestionAnimation(){
    ...
    questionTL.from("#questionScreen", 0.5, {height:109, width: 205, x:-44, y:1, ease:Sine.easeInOut});
    questionTL.to("#stickerWrapper", 0.5, {scale:1, opacity:1, y: -92, x: 20, rotation:0, ease:Sine.easeOut})
