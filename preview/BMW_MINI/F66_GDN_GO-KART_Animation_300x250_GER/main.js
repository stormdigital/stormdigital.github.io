...
function init(clickTAGvalue) {
    ...
    document.querySelector("#mainExit").addEventListener("mouseover", function(){
        ...
        // gsap.set("#bg1", {mixBlendMode: "overlay", opacity:1, rotation:gsap.utils.random(-10, 10)});
        // if(masterTL.progress() > 0.7){
        //     gsap.set("#bg1", {mixBlendMode: "normal", rotation:0, opacity:0, delay:0.2});
        // }
        // else{
        //     gsap.set("#bg1", {mixBlendMode: "normal", rotation:0, delay:0.2});
        // }
        // gsap.set("#bg2", {delay:0.2});
