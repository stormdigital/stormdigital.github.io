...
function getUSPAnimation(){
    ...
    uspTL.from("#uspScreen", 0.5, {height:136, width: 196, ease:Sine.easeInOut});
    uspTL.to("#stickerWrapper", 0.5, {scale:1, opacity:1, y: -71, x: 50, rotation:0, ease:Sine.easeOut})
...
function getQuestionAnimation(){
    ...
    questionTL.from("#questionScreen", 0.5, {height:136, width: 196, ease:Sine.easeInOut});
    questionTL.to("#stickerWrapper", 0.5, {scale:1, opacity:1, y: -71, x: 50, rotation:0, ease:Sine.easeOut})
