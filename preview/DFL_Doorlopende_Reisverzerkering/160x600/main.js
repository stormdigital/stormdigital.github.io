...
function getUSPAnimation(){
    ...
    uspTL.to("#stickerWrapper", 0.5, {scale:1, opacity:1, y:-256, rotation:0, ease:Sine.easeOut})
...
function getQuestionAnimation(){
    ...
    questionTL.to("#stickerWrapper", 0.5, {scale:1, opacity:1, y:-373, rotation:0, ease:Sine.easeOut})
