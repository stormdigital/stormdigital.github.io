...
function getUSPAnimation(){
    ...
    uspTL.from("#uspScreen", 0.5, {width: 392, height: 190, ease:Sine.easeInOut});
    uspTL.to("#stickerWrapper", 0.5, {scale:1, opacity:1, x:470, rotation:0, ease:Sine.easeOut})
...
function getQuestionAnimation(){
    ...
    questionTL.from("#questionScreen", 0.5, {width:392, height: 190, ease:Sine.easeInOut});
    questionTL.to("#stickerWrapper", 0.5, {scale:1, opacity:1, x:494, rotation:0, ease:Sine.easeOut})
...
function createSnow(){
    ...
    for (var i = 0; i < 700; i++) {
        ...
        newDiv.style.left = gsap.utils.random(0, 975)+"px";
