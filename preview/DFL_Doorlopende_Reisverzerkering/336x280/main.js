...
function getUSPAnimation(){
    ...
    uspTL.from("#uspScreen", 0.5, {height:149, width: 207, ease:Sine.easeInOut});
    uspTL.to("#stickerWrapper", 0.5, {scale:1, opacity:1, y: -82, x: 54, rotation:0, ease:Sine.easeOut})
...
function getQuestionAnimation(){
    ...
    questionTL.from("#questionScreen", 0.5, {height:149, width: 207, ease:Sine.easeInOut});
    questionTL.to("#stickerWrapper", 0.5, {scale:1, opacity:1, y: -82, x: 54, rotation:0, ease:Sine.easeOut})
