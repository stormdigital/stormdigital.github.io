...
function getUSPAnimation(){
    ...
    uspTL.to("#stickerWrapper", 0.5, {scale:1, opacity:1, y: -120, x: 120, rotation:0, ease:Sine.easeOut})
...
function getQuestionAnimation(){
    ...
    questionTL.to("#stickerWrapper", 0.5, {scale:1, opacity:1, y: -120, x: 120, rotation:0, ease:Sine.easeOut})
