...
function showAd() {
    ...
    document.querySelector("#mainExit").addEventListener("mouseover", function(){
        if(masterTL.progress() > 0.33){
          ...
          gsap.to("#cta1", 0.3, {y:22, ease:Sine.easeInOut});
          gsap.to("#cta2", 0.3, {y:-11, ease:Sine.easeInOut});
        }
    })
    ...
    console.log("ljkbn");
    masterTL.to("#logoVL", 1.5, {scale:1, x:2534, y:80, force3D:false, ease:Power4.easeInOut}, "start")
