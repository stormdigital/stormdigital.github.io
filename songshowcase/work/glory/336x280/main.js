...
function showAd() {
    ...
    document.querySelector("#mainExit").addEventListener("mouseover", function(){
        if(masterTL.progress() > 0.33){
          ...
          gsap.to("#cta1", 0.3, {y:16, ease:Sine.easeInOut});
          gsap.to("#cta2", 0.3, {y:-8, ease:Sine.easeInOut});
        }
    })
    ...
    masterTL.to("#logoVL", 1.5, {scale:1, x:2885, y:209, ease:Power4.easeInOut}, "start")
    masterTL.from("#bgV", 0.3, {opacity:0, ease:Sine.easeIn}, "start+=1.2")
    masterTL.to("#logoVL", 0.3, {opacity:0, ease:Sine.easeIn}, "start+=1.2")
    masterTL.from("#logoVLSmall", 0.3, {opacity:0, ease:Sine.easeOut}, "start+=1.5")
    masterTL.from("#fighter1", 1, {x:-180, ease:Sine.easeOut}, "start+=1.5")
    masterTL.from("#fighter2", 1, {x:180, ease:Sine.easeOut}, "start+=1.7")
    ...
    masterTL.to("#fighter1", 1, {x:-45, ease:Sine.easeInOut}, "start+=3")
    masterTL.to("#fighter2", 1, {x:45, ease:Sine.easeInOut}, "start+=3")
    masterTL.from("#names", 0.3, {opacity:0, ease:Sine.easeOut}, "start+=3.2")
    masterTL.from("#date", 0.3, {opacity:0, ease:Sine.easeOut}, "start+=3.6")
