...
function init(){
    ...
    masterTL.add("start", "-=1");
    masterTL.to("#bg", 4, {x:-127, ease:Sine.easeOut}, "start");
    masterTL.from("#clydeWrapper", 4, {x:160, ease:Sine.easeOut}, "start");
    masterTL.from("#gun", 4, {rotation:20, ease:Sine.easeInOut}, "start");
    masterTL.from(["#bonnie", "#bonnieGlasses"], 4, {x:185, ease:Sine.easeOut}, "start");
    masterTL.from("#coverup", 4, {x:200, ease:Sine.easeOut}, "start");
    masterTL.from("#logoBC", 0.8, {opacity:0, ease:Sine.easeOut}, "start+=1.5");
    masterTL.from("#tagline", 0.4, {opacity:0, ease:Sine.easeOut}, "start+=2");
    masterTL.from("#shine", 0.7, {x:"-200%", ease:Power0.easeNone}, "start+=2.5");
    masterTL.from("#shine", 0.35, {opacity:0.4, repeat:1, yoyo:true, ease:Power1.easeInOut}, "start+=2.5");
...
function onOver(){
    if(masterTL.progress() == 1 && window.rolloverAllowed){
        ...
        gsap.to("#bg", 0.5, {x:-120, ease:Sine.easeInOut});
        gsap.to("#clydeWrapper", 0.5, {x:14, ease:Sine.easeInOut});
        gsap.to("#gun", 0.5, {rotation:2, ease:Sine.easeInOut});
        gsap.to(["#bonnie", "#bonnieGlasses"], 0.5, {x:18, ease:Sine.easeInOut});
        gsap.to("#coverup", 0.5, {x:22, ease:Sine.easeInOut});
        ...
        gsap.to("#cta", 0.3, {color:"#000", y:-11, background:"#fff", ease:Power1.easeInOut});
    }
}

function onOut(){
    if(masterTL.progress() == 1){
        gsap.to("#bg", 0.5, {x:-127, ease:Sine.easeInOut});
        ...
        gsap.to("#coverup", 0.5, {x:0, ease:Sine.easeInOut});
