...
function init(){
    ...
    masterTL.to("#bg", 4, {x:-44, ease:Sine.easeOut}, "start");
    masterTL.from("#shop", 4, {x:48, ease:Sine.easeOut}, "start");
    masterTL.from("#clydeWrapper", 4, {x:60, ease:Sine.easeOut}, "start");
    masterTL.from("#gun", 4, {rotation:20, ease:Sine.easeInOut}, "start");
    masterTL.from(["#bonnie", "#bonnieGlasses"], 4, {x:70, ease:Sine.easeOut}, "start");
    masterTL.from("#coverup", 4, {x:80, ease:Sine.easeOut}, "start");
    ...
    masterTL.from("#logoBC", 0.4, {opacity:0, ease:Sine.easeOut}, "start+=2");
    masterTL.from("#cta", 0.5, {scale:0, ease:Back.easeOut}, "start+=2.5");
    masterTL.from("#ctaPrice", 0.4, {scale:0, ease:Back.easeOut}, "start+=2.9");
...
function onOver(){
    if(masterTL.progress() == 1 && window.rolloverAllowed){
        ...
        gsap.to("#bg", 0.5, {x:-40, ease:Sine.easeInOut});
        gsap.to("#shop", 0.5, {x:4, ease:Sine.easeInOut});
        ...
        gsap.to("#coverup", 0.5, {x:15, ease:Sine.easeInOut});
        ...
        gsap.to("#cta", 0.3, {color:"#000", background:"#fff", ease:Power1.easeInOut});
    }
}

function onOut(){
    if(masterTL.progress() == 1){
        gsap.to("#bg", 0.5, {x:-44, ease:Sine.easeInOut});
        gsap.to("#shop", 0.5, {x:0, ease:Sine.easeInOut});
        ...
        gsap.to("#cta", 0.3, {color:"#fff", background:"#ec4b4e", ease:Power1.easeInOut});
